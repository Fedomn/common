...
func (p TImpalaQueryOptions) String() string {
	...
	case TImpalaQueryOptions_DEBUG_ACTION:
		return "DEBUG_ACTION"
	case TImpalaQueryOptions_ABORT_ON_DEFAULT_LIMIT_EXCEEDED:
		return "ABORT_ON_DEFAULT_LIMIT_EXCEEDED"
	case TImpalaQueryOptions_COMPRESSION_CODEC:
		return "COMPRESSION_CODEC"
	case TImpalaQueryOptions_HBASE_CACHING:
		return "HBASE_CACHING"
	case TImpalaQueryOptions_HBASE_CACHE_BLOCKS:
		return "HBASE_CACHE_BLOCKS"
	case TImpalaQueryOptions_PARQUET_FILE_SIZE:
		return "PARQUET_FILE_SIZE"
	case TImpalaQueryOptions_EXPLAIN_LEVEL:
		return "EXPLAIN_LEVEL"
	case TImpalaQueryOptions_SYNC_DDL:
		return "SYNC_DDL"
	case TImpalaQueryOptions_REQUEST_POOL:
		return "REQUEST_POOL"
	case TImpalaQueryOptions_V_CPU_CORES:
		return "V_CPU_CORES"
	case TImpalaQueryOptions_RESERVATION_REQUEST_TIMEOUT:
		return "RESERVATION_REQUEST_TIMEOUT"
	case TImpalaQueryOptions_DISABLE_CACHED_READS:
		return "DISABLE_CACHED_READS"
	case TImpalaQueryOptions_DISABLE_OUTERMOST_TOPN:
		return "DISABLE_OUTERMOST_TOPN"
	case TImpalaQueryOptions_RM_INITIAL_MEM:
		return "RM_INITIAL_MEM"
	case TImpalaQueryOptions_QUERY_TIMEOUT_S:
		return "QUERY_TIMEOUT_S"
	case TImpalaQueryOptions_MAX_BLOCK_MGR_MEMORY:
		return "MAX_BLOCK_MGR_MEMORY"
	case TImpalaQueryOptions_APPX_COUNT_DISTINCT:
		return "APPX_COUNT_DISTINCT"
	case TImpalaQueryOptions_DISABLE_UNSAFE_SPILLS:
...
func TImpalaQueryOptionsFromString(s string) (TImpalaQueryOptions, error) {
	...
	case "ABORT_ON_DEFAULT_LIMIT_EXCEEDED":
		return TImpalaQueryOptions_ABORT_ON_DEFAULT_LIMIT_EXCEEDED, nil
	case "COMPRESSION_CODEC":
		return TImpalaQueryOptions_COMPRESSION_CODEC, nil
	case "HBASE_CACHING":
		return TImpalaQueryOptions_HBASE_CACHING, nil
	case "HBASE_CACHE_BLOCKS":
		return TImpalaQueryOptions_HBASE_CACHE_BLOCKS, nil
	case "PARQUET_FILE_SIZE":
		return TImpalaQueryOptions_PARQUET_FILE_SIZE, nil
	case "EXPLAIN_LEVEL":
		return TImpalaQueryOptions_EXPLAIN_LEVEL, nil
	case "SYNC_DDL":
		return TImpalaQueryOptions_SYNC_DDL, nil
	case "REQUEST_POOL":
		return TImpalaQueryOptions_REQUEST_POOL, nil
	case "V_CPU_CORES":
		return TImpalaQueryOptions_V_CPU_CORES, nil
	case "RESERVATION_REQUEST_TIMEOUT":
		return TImpalaQueryOptions_RESERVATION_REQUEST_TIMEOUT, nil
	case "DISABLE_CACHED_READS":
		return TImpalaQueryOptions_DISABLE_CACHED_READS, nil
	case "DISABLE_OUTERMOST_TOPN":
		return TImpalaQueryOptions_DISABLE_OUTERMOST_TOPN, nil
	case "RM_INITIAL_MEM":
		return TImpalaQueryOptions_RM_INITIAL_MEM, nil
	case "QUERY_TIMEOUT_S":
		return TImpalaQueryOptions_QUERY_TIMEOUT_S, nil
	case "MAX_BLOCK_MGR_MEMORY":
		return TImpalaQueryOptions_MAX_BLOCK_MGR_MEMORY, nil
	case "APPX_COUNT_DISTINCT":
		return TImpalaQueryOptions_APPX_COUNT_DISTINCT, nil
	case "DISABLE_UNSAFE_SPILLS":
		return TImpalaQueryOptions_DISABLE_UNSAFE_SPILLS, nil
	}
...
func (p *ImpalaServiceClient) ResetCatalog(ctx context.Context) (r *status.TStatus, err error) {
	...
	if err = p.Client_().Call(ctx, "ResetCatalog", &_args4, &_result5); err != nil {
		return
	}
...
func (p *ImpalaServiceClient) ResetTable(ctx context.Context, request *TResetTableReq) (r *status.TStatus, err error) {
	...
	if err = p.Client_().Call(ctx, "ResetTable", &_args6, &_result7); err != nil {
		return
	}
...
func (p *ImpalaServiceClient) GetRuntimeProfile(ctx context.Context, query_id *beeswax.QueryHandle) (r string, err error) {
	...
	if err = p.Client_().Call(ctx, "GetRuntimeProfile", &_args8, &_result9); err != nil {
		return
	}
	switch {
...
func (p *ImpalaServiceClient) CloseInsert(ctx context.Context, handle *beeswax.QueryHandle) (r *TInsertResult_, err error) {
	...
	if err = p.Client_().Call(ctx, "CloseInsert", &_args10, &_result11); err != nil {
		return
	}
	switch {
...
func (p *ImpalaServiceClient) PingImpalaService(ctx context.Context) (r *TPingImpalaServiceResp, err error) {
	...
	if err = p.Client_().Call(ctx, "PingImpalaService", &_args12, &_result13); err != nil {
		return
	}
...
func (p *ImpalaServiceClient) GetExecSummary(ctx context.Context, handle *beeswax.QueryHandle) (r *execstats.TExecSummary, err error) {
	...
	if err = p.Client_().Call(ctx, "GetExecSummary", &_args14, &_result15); err != nil {
		return
	}
	switch {
...
func (p *ImpalaHiveServer2ServiceClient) GetExecSummary(ctx context.Context, req *TGetExecSummaryReq) (r *TGetExecSummaryResp, err error) {
	...
	if err = p.Client_().Call(ctx, "GetExecSummary", &_args96, &_result97); err != nil {
		return
	}
...
func (p *ImpalaHiveServer2ServiceClient) GetRuntimeProfile(ctx context.Context, req *TGetRuntimeProfileReq) (r *TGetRuntimeProfileResp, err error) {
	...
	if err = p.Client_().Call(ctx, "GetRuntimeProfile", &_args98, &_result99); err != nil {
		return
	}
