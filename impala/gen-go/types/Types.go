...
func (p TPrimitiveType) String() string {
	...
	case TPrimitiveType_DATETIME:
		return "DATETIME"
	case TPrimitiveType_TIMESTAMP:
		return "TIMESTAMP"
	case TPrimitiveType_STRING:
		return "STRING"
	case TPrimitiveType_BINARY:
		return "BINARY"
	case TPrimitiveType_DECIMAL:
		return "DECIMAL"
...
func TPrimitiveTypeFromString(s string) (TPrimitiveType, error) {
	...
	case "TIMESTAMP":
		return TPrimitiveType_TIMESTAMP, nil
	case "STRING":
		return TPrimitiveType_STRING, nil
	case "BINARY":
		return TPrimitiveType_BINARY, nil
	case "DECIMAL":
		return TPrimitiveType_DECIMAL, nil
	case "CHAR":
...
func TStmtTypeFromString(s string) (TStmtType, error) {
	...
	case "LOAD":
		return TStmtType_LOAD, nil
	case "SET":
		return TStmtType_SET, nil
	}
...
func (p TExplainLevel) String() string {
	switch p {
	case TExplainLevel_MINIMAL:
		return "MINIMAL"
	case TExplainLevel_STANDARD:
		return "STANDARD"
	case TExplainLevel_EXTENDED:
		return "EXTENDED"
...
func TExplainLevelFromString(s string) (TExplainLevel, error) {
	switch s {
	case "MINIMAL":
		return TExplainLevel_MINIMAL, nil
	case "STANDARD":
		return TExplainLevel_STANDARD, nil
	case "EXTENDED":
		return TExplainLevel_EXTENDED, nil
	case "VERBOSE":
...
func (p TFunctionCategory) String() string {
	switch p {
	case TFunctionCategory_SCALAR:
		return "SCALAR"
	case TFunctionCategory_AGGREGATE:
		return "AGGREGATE"
	case TFunctionCategory_ANALYTIC:
		return "ANALYTIC"
	}
	return "<UNSET>"
}
...
func TFunctionCategoryFromString(s string) (TFunctionCategory, error) {
	switch s {
	case "SCALAR":
		return TFunctionCategory_SCALAR, nil
	case "AGGREGATE":
		return TFunctionCategory_AGGREGATE, nil
	case "ANALYTIC":
		return TFunctionCategory_ANALYTIC, nil
	}
...
type TAggregateFunction struct {
	...
	UpdateFnSymbol    string       `thrift:"update_fn_symbol,2,required" db:"update_fn_symbol" json:"update_fn_symbol"`
	InitFnSymbol      string       `thrift:"init_fn_symbol,3,required" db:"init_fn_symbol" json:"init_fn_symbol"`
	SerializeFnSymbol *string      `thrift:"serialize_fn_symbol,4" db:"serialize_fn_symbol" json:"serialize_fn_symbol,omitempty"`
	MergeFnSymbol     *string      `thrift:"merge_fn_symbol,5" db:"merge_fn_symbol" json:"merge_fn_symbol,omitempty"`
	FinalizeFnSymbol  *string      `thrift:"finalize_fn_symbol,6" db:"finalize_fn_symbol" json:"finalize_fn_symbol,omitempty"`
	IgnoresDistinct   *bool        `thrift:"ignores_distinct,7" db:"ignores_distinct" json:"ignores_distinct,omitempty"`
...
func (p *TAggregateFunction) writeField2(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("update_fn_symbol", thrift.STRING, 2); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:update_fn_symbol: ", p), err)
	}
	if err := oprot.WriteString(string(p.UpdateFnSymbol)); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T.update_fn_symbol (2) field write error: ", p), err)
	}
	if err := oprot.WriteFieldEnd(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field end error 2:update_fn_symbol: ", p), err)
	}
	return err
}
...
func (p *TAggregateFunction) writeField3(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("init_fn_symbol", thrift.STRING, 3); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 3:init_fn_symbol: ", p), err)
	}
	if err := oprot.WriteString(string(p.InitFnSymbol)); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T.init_fn_symbol (3) field write error: ", p), err)
	}
	if err := oprot.WriteFieldEnd(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field end error 3:init_fn_symbol: ", p), err)
	}
	return err
}
...
func (p *TAggregateFunction) writeField4(oprot thrift.TProtocol) (err error) {
	if p.IsSetSerializeFnSymbol() {
		if err := oprot.WriteFieldBegin("serialize_fn_symbol", thrift.STRING, 4); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 4:serialize_fn_symbol: ", p), err)
		}
		if err := oprot.WriteString(string(*p.SerializeFnSymbol)); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T.serialize_fn_symbol (4) field write error: ", p), err)
		}
		if err := oprot.WriteFieldEnd(); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field end error 4:serialize_fn_symbol: ", p), err)
		}
	}
	return err
}
...
func (p *TAggregateFunction) writeField5(oprot thrift.TProtocol) (err error) {
	if p.IsSetMergeFnSymbol() {
		if err := oprot.WriteFieldBegin("merge_fn_symbol", thrift.STRING, 5); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 5:merge_fn_symbol: ", p), err)
		}
		if err := oprot.WriteString(string(*p.MergeFnSymbol)); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T.merge_fn_symbol (5) field write error: ", p), err)
		}
		if err := oprot.WriteFieldEnd(); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field end error 5:merge_fn_symbol: ", p), err)
		}
	}
	return err
}
...
func (p *TAggregateFunction) writeField6(oprot thrift.TProtocol) (err error) {
	if p.IsSetFinalizeFnSymbol() {
		if err := oprot.WriteFieldBegin("finalize_fn_symbol", thrift.STRING, 6); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 6:finalize_fn_symbol: ", p), err)
		}
		if err := oprot.WriteString(string(*p.FinalizeFnSymbol)); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T.finalize_fn_symbol (6) field write error: ", p), err)
		}
		if err := oprot.WriteFieldEnd(); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field end error 6:finalize_fn_symbol: ", p), err)
		}
	}
	return err
}
...
func (p *TAggregateFunction) writeField7(oprot thrift.TProtocol) (err error) {
	if p.IsSetIgnoresDistinct() {
		if err := oprot.WriteFieldBegin("ignores_distinct", thrift.BOOL, 7); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 7:ignores_distinct: ", p), err)
		}
		if err := oprot.WriteBool(bool(*p.IgnoresDistinct)); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T.ignores_distinct (7) field write error: ", p), err)
		}
		if err := oprot.WriteFieldEnd(); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field end error 7:ignores_distinct: ", p), err)
		}
	}
	return err
}
